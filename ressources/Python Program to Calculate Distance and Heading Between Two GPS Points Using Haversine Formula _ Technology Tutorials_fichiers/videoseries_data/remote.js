...
C:"ytp-mdx-popup-dialog",N:{role:"dialog"},J:[{X:"div",C:"ytp-mdx-popup-dialog-inner-content",J:[{X:"div",C:"ytp-mdx-popup-title",Rl:"Vous \u00eates d\u00e9connect\u00e9"},{X:"div",C:"ytp-mdx-popup-description",Rl:"Les vid\u00e9os que vous visionnez peuvent \u00eatre ajout\u00e9es \u00e0 l'historique des vid\u00e9os regard\u00e9es sur votre t\u00e9l\u00e9viseur et avoir une influence sur les recommandations qui vous sont faites. Pour \u00e9viter ce probl\u00e8me, annulez et connectez-vous \u00e0 YouTube sur un ordinateur."},
{X:"div",C:"ytp-mdx-privacy-popup-buttons",J:[{X:"button",Fj:["ytp-button","ytp-mdx-privacy-popup-cancel"],Rl:"Annuler"},{X:"button",Fj:["ytp-button","ytp-mdx-privacy-popup-confirm"],Rl:"Confirmer"}]}]}]});this.fade=new g.AV(this,250);this.cancelButton=this.DN("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.DN("ytp-mdx-privacy-popup-confirm");g.t(this,this.fade);this.Z(this.cancelButton,"click",this.K);this.Z(this.confirmButton,"click",this.j)},Wo=function(O){g.r.call(this,{X:"div",
C:"ytp-remote",J:[{X:"div",C:"ytp-remote-display-status",J:[{X:"div",C:"ytp-remote-display-status-icon",J:[g.ryp()]},{X:"div",C:"ytp-remote-display-status-text",Rl:"{{statustext}}"}]}]});this.api=O;this.fade=new g.AV(this,250);g.t(this,this.fade);this.Z(O,"presentingplayerstatechange",this.onStateChange);this.gX(O.getPlayerStateObject())},Uv=function(O,V){g.og.call(this,"Lire sur",1,O,V);
...
break;case -1:this.mA(new g.nr(64));break;case -1E3:this.mA(new g.nr(128,{errorCode:"mdx.remoteerror",errorMessage:"Cette vid\u00e9o ne peut pas \u00eatre visionn\u00e9e \u00e0 distance.",vj:2}))}O=qC(this.hx).trackData;var V=this.D;(O||V?O&&V&&O.trackName==V.trackName&&O.languageCode==V.languageCode&&O.languageName==V.languageName&&O.kind==V.kind:1)||(this.D=O,KNd(this,O));O=qC(this.hx);O.volume===-1||Math.round(this.G.getVolume())===O.volume&&this.G.isMuted()===O.muted||this.qX.isActive()||this.kf()}else Qjn(this)};
...
Wo.prototype.gX=function(O){if(this.api.getPresentingPlayerType()===3){var V={RECEIVER_NAME:this.api.getOption("remote","currentReceiver").name};O=g.R(O,128)?g.kv("Erreur sur $RECEIVER_NAME",V):O.isPlaying()||O.isPaused()?g.kv("Lecture sur $RECEIVER_NAME",V):g.kv("Connect\u00e9 \u00e0 $RECEIVER_NAME",V);this.updateValue("statustext",O);this.fade.show()}else this.fade.hide()};g.I(Uv,g.og);Uv.prototype.j=function(){var O=this.G.getOption("remote","receivers");O&&O.length>1&&!this.G.getOption("remote","quickCast")?(this.NB=g.FC(O,this.K,this),this.w8(g.Ia(O,this.K)),O=this.G.getOption("remote","currentReceiver"),O=this.K(O),this.options[O]&&this.bB(O),this.enable(!0)):this.enable(!1)};
Uv.prototype.K=function(O){return O.key};
Uv.prototype.r0=function(O){return O==="cast-selector-receiver"?"Caster sur\u2026":this.NB[O].name};
